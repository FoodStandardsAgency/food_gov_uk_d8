...
const includedComponents = ['next-previous', 'back-to-top', 'document-menu', 'button', 'breadcrumb', 'contact-links', 'feedback', 'footer', 'form', 'header', 'hero', 'infobox', 'landing-links', 'landing-promo', 'language-bar', 'latest-news', 'link-list', 'listing', 'navigation', 'pager', 'pagination', 'promo', 'share']
