...
const includedComponents = ['button', 'breadcrumb', 'footer', 'header', 'hero', 'infobox', 'landing-links', 'landing-promo', 'link-list', 'listing', 'navigation', 'pager', 'pagination', 'promo', 'share']
