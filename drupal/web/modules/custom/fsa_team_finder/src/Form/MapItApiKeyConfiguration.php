...
class MapItApiKeyConfiguration extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['mapit_api_key'] = [
      ...
      '#description' => 'This key enables unlimited calls to the MapIt API, which identifies a responsible Local Authority for a given postcode. See: <a href="https://mapit.mysociety.org/">https://mapit.mysociety.org/</a>.',
    ];
