...
class FsaRatingsSearchForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['advanced_button'] = [
      '#type' => 'item',
      '#prefix' => '<div class="ratings__advanced-search-button toggle-button js-toggle-button"><div class="toggle-button__item">More search options</div>',
      '#suffix' => '<div class="toggle-button__item toggle-button__item--icon"><div class="toggle-button__fallback-icon"></div></div></div>',
    ];

    $form['advanced'] = [
      '#type' => 'item',
      '#prefix' => '<div class="toggle-content js-toggle-content">',
      '#suffix' => '</div>',
      '#attributes' => [
        'class' => [
