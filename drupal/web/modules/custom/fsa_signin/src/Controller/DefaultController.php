...
class DefaultController extends ControllerBase {
  ...
  public function accountSettingsPage() {
    ...
    $content .= '<p>' . $this->t('Manage your profile from the links below or set your alert subscription preferences from the tabs above.') . '</p>';
    $content .= '<p>' . DefaultController::linkMarkup('fsa_signin.default_controller_changePasswordPage', $this->t('Update password'), ['button button--profile-manage']) . '</p>';
    // @todo: inline-css to demo alternative on the page. Move to css.
    $content .= '<p>' . DefaultController::linkMarkup('fsa_signin.delete_account_confirmation', $this->t('Cancel your subscription'), ['cancel button red button--profile-manage']) . '</p>';
